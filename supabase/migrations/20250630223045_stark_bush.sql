/*
  # Fix critical inventory handling

  1. Changes
     - Add is_critical column to inventory_items table
     - Update specific inventory items to mark some as non-critical
     - Update menu item availability function to only consider critical ingredients
*/
