...
BEGIN
  ...
  LOOP
    ...
    IF menu_item_record.required_inventory IS NOT NULL THEN
      FOR i IN 1..array_length(menu_item_record.required_inventory, 1)
      LOOP
        inventory_item_name := menu_item_record.required_inventory[i];
        ...
        IF inventory_item_record IS NOT NULL AND 
           inventory_item_record.is_critical = true AND 
           inventory_item_record.quantity <= 0 THEN
