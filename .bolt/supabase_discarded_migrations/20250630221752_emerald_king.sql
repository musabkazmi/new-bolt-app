/*
  # Add critical ingredients support
  
  1. Changes
     - Add `is_critical` boolean column to inventory_items table
     - Update existing inventory items to mark critical status
     - Modify the update_menu_item_availability function to only consider critical ingredients
